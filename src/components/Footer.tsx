...
const Footer = () => {
  return (
    <footer id="contato" className="gradient-hero text-primary-foreground pt-16 pb-8">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <div className="flex flex-col">
                <span className="font-bold text-xl leading-none">Sinos</span>
                <span className="text-xs text-primary-foreground/70 tracking-wide">IMÓVEIS</span>
              </div>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-center gap-3 text-sm">
                ...
                <span className="text-primary-foreground/80">(51) 3333-0000</span>
              </li>
              <li className="flex items-center gap-3 text-sm">
                <Mail className="w-5 h-5 text-accent" />
                <span className="text-primary-foreground/80">contato@sinosimoveis.com.br</span>
              </li>

  ...
  return (
    <section className="relative">
      ...
      <div style={{ backgroundColor: "#89A0B7" }}>
        <div className="relative -mt-14 pb-6 flex items-start justify-center gap-3 px-4">
          {/* Search block */}
          <div
          ...
          >
            ...
            <div className="flex items-center gap-2">
              <div className="flex items-center flex-1 bg-white rounded-full px-4 py-2 h-11">
              ...
              <button
                ...
                className="shrink-0 rounded-full px-6 py-2 h-11 text-sm font-bold transition-colors hover:brightness-95 active:scale-[0.97]"

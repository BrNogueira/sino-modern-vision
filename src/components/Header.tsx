    ...
    <header className="absolute top-0 left-0 right-0 z-50">
      <div className="container mx-auto px-4 flex items-center justify-between py-4">
        ...
        <div className="hidden md:flex items-center gap-6">
          ...
          <Link
            to="/favoritos"
            className="flex items-center gap-1.5 text-primary-foreground hover:text-accent transition-colors"
          >
            <Star className="w-5 h-5 fill-yellow-400 text-yellow-400" />
            <span className="text-sm font-semibold">Favoritos</span>
            {count > 0 && (
              <span className="bg-[#FFC000] text-foreground text-xs font-bold px-1.5 py-0.5 rounded-full min-w-[20px] text-center">
                {count}
              </span>
            )}
          </Link>
        ...
        <div className="flex md:hidden items-center gap-3">
          <Link to="/favoritos" className="relative text-primary-foreground">
            ...
            {count > 0 && (
              <span className="absolute -top-1 -right-1 bg-[#FFC000] text-foreground text-[10px] font-bold px-1 rounded-full min-w-[16px] text-center">
                {count}
              </span>
            )}
          </Link>
